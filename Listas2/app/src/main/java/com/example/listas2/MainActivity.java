...
public void onCreate(Bundle b) {
    ...
    private List<NuevaEntrada> getEntradas() {
        ...
        for(int i = 1; i < 31; i++) { datos.add(
                new NuevaEntrada("Datos de Entrada " + i, "Gustavo Rodriguez " + i, new GregorianCalendar(2022, 02, i).getTime(), i % 2 == 0 ? R.drawable.icon_1 : R.drawable.icon_2));
        }
        return datos;
    }
}