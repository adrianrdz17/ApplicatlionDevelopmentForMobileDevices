...
import java.text.DateFormat; import android.content.Context; import android.view.*;
...
public final class NuevaEntradaAdapter extends ArrayAdapter<NuevaEntrada> {
    ...
    public View getView(final int i, final View v, final ViewGroup vg) {
        final View v2 = getWorkingView(v); final ViewHolder vh = getViewHolder(v2); final NuevaEntrada ne = getItem(i); vh.tituloView.setText(ne.getTitulo());
    ...
    private ViewHolder getViewHolder(final View workingView) {
        ...
        if(null == tag || !(tag instanceof ViewHolder)) { vh = new ViewHolder();
            ...
            vh.subTituloView = (TextView) workingView.findViewById(R.id.xtvsubtitulo); vh.imagenView = (ImageView) workingView.findViewById(R.id.xivicono); workingView.setTag(vh);
        } else {
            vh = (ViewHolder) tag;
        }
        return vh;
    }
    private static class ViewHolder { public TextView tituloView; public TextView subTituloView; public ImageView imagenView;
    }
}