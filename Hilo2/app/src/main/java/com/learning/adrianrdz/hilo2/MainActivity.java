package com.learning.adrianrdz.hilo2;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle b) {
        ...
        Hilo h1 = new Hilo(10, 500); // 1seg = 1000ms
    ...
    class Hilo extends Thread{
        ...
        public void run(){
            for(int i=0; i<n; i++){
                ...
                b.putString("hilo", currentThread().getName().toString() + " " + currentThread().getId());//hilo=currentThread()
                m.setData(b);
                h.sendMessage(m);
            }
        }
